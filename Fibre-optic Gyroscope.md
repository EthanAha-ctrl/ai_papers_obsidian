# Fibre-optic Gyroscope (FOG) 深度技术讲解

## 1. 基本原理概述

**FOG (Fibre-optic Gyroscope)** 是一种基于 **Sagnac effect** 的惯性传感器，用于检测 **angular velocity (角速度)** 和 **orientation changes (姿态变化)**。与传统的 **mechanical gyroscope (机械陀螺仪)** 不同，FOG 完全没有 **moving parts (活动部件)**，而是利用 **optical interference (光学干涉)** 来感知旋转。

### 核心物理机制

FOG 的核心是 **Sagnac interferometer (Sagnac干涉仪)**，其工作原理如下：
...
**Space Applications (航天应用):**
- Satellite attitude control (卫星姿态控制)
- Spacecraft navigation (航天器导航)
- Reference: NASA FOG implementation

**Military Applications (军事应用):**
- Missile guidance (导弹制导)
- Howitzer pointing systems (火炮瞄准系统)
- Inertial navigation systems (惯导系统)

**Civil Applications (民用应用):**
- Autonomous vehicles (自动驾驶车辆)
- Robotics (机器人)
- Surveying and mapping (测量和测绘)
...
1. **Vali & Shorthill (1976)** - Original FOG proposal
   - Link: https://doi.org/10.1364/AO.15.001099

2. **Hervé Lefèvre, "The Fiber-Optic Gyroscope" (1993)**
   - Artech House, ISBN 0-89006-537-3

3. **Anthony Lawrence, "Modern Inertial Technology" (1998)**
   - Springer, Chapters 11-12

### 在线资源

1. **Wikipedia FOG Article:**
   https://en.wikipedia.org/wiki/Fibre-optic_gyroscope

2. **Sagnac Effect Explanation:**
   https://en.wikipedia.org/wiki/Sagnac_effect

3. **Ring Laser Gyroscope (for comparison):**
   https://en.wikipedia.org/wiki/Ring_laser_gyroscope

4. **NASA Space Applications of FOG:**
   https://ntrs.nasa.gov/api/citations/20150012300/downloads/20150012300.pdf

5. **FOG Tutorial by KVH Industries:**
   https://www.kvh.com/Products-and-Solutions/Fiber-Optic-Gyroscopes.aspx

6. **IEEE Xplore FOG Papers:**
   https://ieeexplore.ieee.org/search/searchresult.jsp?newsearch=true&queryText=fiber+optic+gyroscope

7. **SPIE Digital Library on FOG:**
   https://www.spiedigitallibrary.org/

### 技术标准

1. **IEEE Std 952-1997**: IEEE Standard Specification Format Guide and Test Procedure for Single-Axis Laser Gyros
   - Link: https://standards.ieee.org/

2. **IEEE Std 1431-2004**: IEEE Standard Specification Format Guide and Test Procedure for Single-Axis Interferometric Fiber Optic Gyros
   - Link: https://standards.ieee.org/

希望这个详细的技术讲解能够帮助您建立对 **Fibre-optic Gyroscope** 的深入理解！