...
现在我已经全面阅读了论文和你的背景文字，下面从第一性原理出发，系统性地讲解 **Matryoshka Representation Learning (MRL)**。

---

# 🪆 Matryoshka Representation Learning：从第一性原理到 Qwen3 实践

## 一、命名的直觉：俄罗斯套娃隐喻

**Matryoshka**（Матрёшка）是俄罗斯套娃——一个大娃娃里面嵌套着一个小娃娃，小娃娃里又嵌套更小的娃娃。MRL 的核心思想与之一致：
