**一个未经指令微调的 Language Model 只是互联网文本的概率性压缩，它不知道“人类意图”与“模型输出”之间的映射关系。** Google Flan-T5 在于：**通过大规模、多样化的 Instruction Tuning，将 Foundation Model 的潜力激活为 Zero-shot 能力。** 
