...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(17\).png)  

## [](https://huggingface.co/blog/zh/smollm3#%E6%A8%A1%E5%9E%8B%E6%A6%82%E8%A6%81%EF%BC%9A)模型概要：
...
## [](https://huggingface.co/blog/zh/smollm3#%E5%AE%8C%E6%95%B4%E6%9E%84%E5%BB%BA%E7%BB%86%E8%8A%82)**完整构建细节**
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/smollm3-whiteprint.png)  

无论你是在构建自己的模型，还是想深入理解在这个参数规模上如何实现出色性能，这份蓝图将帮助你系统的了解一个有竞争力的 3B 模型背后的工程故事。

现在，让我们一起来看看预训练阶段。

# [](https://huggingface.co/blog/zh/smollm3#%E9%A2%84%E8%AE%AD%E7%BB%83)预训练

SmolLM3 在架构和数据混合策略上都相较于前代模型进行了改进。让我们先来看看它的**模型架构**和**训练配置**吧！

## [](https://huggingface.co/blog/zh/smollm3#%E6%9E%B6%E6%9E%84%E4%B8%8E%E8%AE%AD%E7%BB%83%E7%BB%86%E8%8A%82)**架构与训练细节**

![64](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(18\).png)  

SmolLM3 采用了基于 Transformer 解码器的架构，并与 SmolLM2 类似使用共享嵌入（tied embedding）。该模型构建在 Llama 架构之上，并进行了若干关键改进，以优化推理效率和长上下文性能。

### [](https://huggingface.co/blog/zh/smollm3#%E5%88%86%E7%BB%84%E6%9F%A5%E8%AF%A2%E6%B3%A8%E6%84%8F%E5%8A%9B%E6%9C%BA%E5%88%B6)**分组查询注意力机制**
...
### [](https://huggingface.co/blog/zh/smollm3#%E5%BD%92%E4%B8%80%E5%8C%96%E4%BD%8D%E7%BD%AE%E7%BC%96%E7%A0%81)**归一化位置编码**
...
### [](https://huggingface.co/blog/zh/smollm3#%E6%96%87%E5%86%85%E6%B3%A8%E6%84%8F%E5%8A%9B%E5%B1%8F%E8%94%BD)**文内注意力屏蔽**
...
### [](https://huggingface.co/blog/zh/smollm3#%E8%AE%AD%E7%BB%83%E7%A8%B3%E5%AE%9A%E6%80%A7%E4%BC%98%E5%8C%96)**训练稳定性优化**
...
### [](https://huggingface.co/blog/zh/smollm3#%E8%AE%AD%E7%BB%83%E9%85%8D%E7%BD%AE)**训练配置**
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(19\).png)  

除了架构优化，我们还对整个训练流程进行了深入的消融实验与配方改进。接下来，让我们更深入地了解预训练数据的策略与演化过程。

## [](https://huggingface.co/blog/zh/smollm3#%E6%95%B0%E6%8D%AE%E6%B7%B7%E5%90%88%E4%B8%8E%E8%AE%AD%E7%BB%83%E9%98%B6%E6%AE%B5)**数据混合与训练阶段**
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(20\).png)  

预训练包含以下几个阶段，上图中亦有所展示：

### [](https://huggingface.co/blog/zh/smollm3#%E9%98%B6%E6%AE%B5%E4%B8%80%EF%BC%9A%E7%A8%B3%E5%AE%9A%E9%98%B6%E6%AE%B5%EF%BC%880t-%E2%86%92-8t-tokens%EF%BC%89)**阶段一：稳定阶段（0T → 8T tokens）**
...
### [](https://huggingface.co/blog/zh/smollm3#%E9%98%B6%E6%AE%B5%E4%BA%8C%EF%BC%9A%E7%A8%B3%E5%AE%9A%E9%98%B6%E6%AE%B5%EF%BC%888t-%E2%86%92-10t-tokens%EF%BC%89)**阶段二：稳定阶段（8T → 10T tokens）**
...
### [](https://huggingface.co/blog/zh/smollm3#%E9%98%B6%E6%AE%B5%E4%B8%89%EF%BC%9A%E8%A1%B0%E5%87%8F%E9%98%B6%E6%AE%B5%EF%BC%8810t-%E2%86%92-111t-tokens%EF%BC%89)**阶段三：衰减阶段（10T → 11.1T tokens）**
...
# [](https://huggingface.co/blog/zh/smollm3#%E4%B8%AD%E6%9C%9F%E8%AE%AD%E7%BB%83)中期训练

我们将 **长上下文适配** 和 **推理能力适配** 称为 **“中期训练”（mid-training）**。这两个阶段虽然远短于主预训练过程，但仍保持一定的通用性，主要目标是进一步提升模型在这两个关键方向的表现。

首先让我们来看长上下文训练部分。

## [](https://huggingface.co/blog/zh/smollm3#%E9%95%BF%E4%B8%8A%E4%B8%8B%E6%96%87%E6%89%A9%E5%B1%95)**长上下文扩展**

![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(21\).png)  
...
## [](https://huggingface.co/blog/zh/smollm3#%E6%8E%A8%E7%90%86%E4%B8%AD%E6%9C%9F%E8%AE%AD%E7%BB%83)**推理中期训练**
...
# [](https://huggingface.co/blog/zh/smollm3#%E5%90%8E%E8%AE%AD%E7%BB%83)后训练
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(22\).png)  

## [](https://huggingface.co/blog/zh/smollm3#%E6%9E%84%E5%BB%BA%E8%81%8A%E5%A4%A9%E6%A8%A1%E6%9D%BF)**构建聊天模板**
...
### [](https://huggingface.co/blog/zh/smollm3#%E5%B7%A5%E5%85%B7%E8%B0%83%E7%94%A8%E6%94%AF%E6%8C%81)**工具调用支持**
...
### [](https://huggingface.co/blog/zh/smollm3#%E7%B3%BB%E7%BB%9F%E6%B6%88%E6%81%AF%E4%B8%8E%E5%85%83%E4%BF%A1%E6%81%AF)**系统消息与元信息**
...
## [](https://huggingface.co/blog/zh/smollm3#%E7%9B%91%E7%9D%A3%E5%BE%AE%E8%B0%83)**监督微调**
...
### [](https://huggingface.co/blog/zh/smollm3#%E6%95%B0%E6%8D%AE%E6%8C%91%E6%88%98%E4%B8%8E%E5%90%88%E6%88%90%E6%95%B0%E6%8D%AE%E7%94%9F%E6%88%90)**数据挑战与合成数据生成**
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(23\).png)  

### [](https://huggingface.co/blog/zh/smollm3#%E6%9C%80%E7%BB%88%E6%95%B0%E6%8D%AE%E6%B7%B7%E5%90%88%E4%B8%8E%E8%AE%AD%E7%BB%83%E8%AE%BE%E7%BD%AE)**最终数据混合与训练设置**
...
## [](https://huggingface.co/blog/zh/smollm3#%E4%BD%BF%E7%94%A8-%E9%94%9A%E5%AE%9A%E5%81%8F%E5%A5%BD%E4%BC%98%E5%8C%96%EF%BC%88apo%EF%BC%89%E8%BF%9B%E8%A1%8C%E7%A6%BB%E7%AD%96%E7%95%A5%E6%A8%A1%E5%9E%8B%E5%AF%B9%E9%BD%90)**使用 锚定偏好优化（APO）进行离策略模型对齐**
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(24\).png)  

### [](https://huggingface.co/blog/zh/smollm3#%E9%94%9A%E5%AE%9A%E5%81%8F%E5%A5%BD%E4%BC%98%E5%8C%96%EF%BC%88apo%EF%BC%89%E7%AE%80%E4%BB%8B)**锚定偏好优化（APO）简介**
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(25\).png)  

其中，参数 $\beta$ 控制当前模型相对于参考模型可变化的幅度。  
DPO 的损失函数基于三元组进行优化：prompt $x$、优选响应 $y_w$ 和被拒响应 $y_l$：

![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(26\).png)  

在我们内部的消融实验中，**APO 表现出更高的稳定性**，并带来了更优的下游任务性能：

![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(27\).png)  

### [](https://huggingface.co/blog/zh/smollm3#%E6%80%A7%E8%83%BD%E8%A7%82%E5%AF%9F%E4%B8%8E%E6%8C%91%E6%88%98)**性能观察与挑战**
...
### [](https://huggingface.co/blog/zh/smollm3#%E8%A7%A3%E5%86%B3%E6%96%B9%E6%A1%88%E6%8E%A2%E7%B4%A2)**解决方案探索**

为缓解这一性能下降问题，我们进一步探索了**模型合并**作为可行的解决路径。

## [](https://huggingface.co/blog/zh/smollm3#%E6%A8%A1%E5%9E%8B%E5%90%88%E5%B9%B6)**模型合并**
...
### [](https://huggingface.co/blog/zh/smollm3#%E6%88%91%E4%BB%AC%E7%9A%84%E5%90%88%E5%B9%B6%E6%B5%81%E7%A8%8B%E5%8C%85%E6%8B%AC%E4%B8%A4%E4%B8%AA%E6%AD%A5%E9%AA%A4%EF%BC%9A)**我们的合并流程包括两个步骤：**
...
# [](https://huggingface.co/blog/zh/smollm3#%E8%AF%84%E4%BC%B0)**评估**

接下来，我们将展示该模型与基础模型（base model）在各类评估任务中的表现结果。我们对 **基础模型** 和 **指令模型** 分别在 **推理模式**与**非推理模式**下进行了系统评估。让我们首先来看基础模型的整体表现！

## [](https://huggingface.co/blog/zh/smollm3#%E5%9F%BA%E7%A1%80%E6%A8%A1%E5%9E%8B)**基础模型**
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(28\).png)  
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(33\).png)  
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(30\).png)  

### [](https://huggingface.co/blog/zh/smollm3#%E2%9C%85-%E6%80%BB%E7%BB%93%EF%BC%9A)✅ 总结：

SmolLM3 的基础模型在多个核心任务领域中都展现了非常出色的性能表现，包括通识推理、数学、代码、多语言与长文本处理能力。接下来，让我们看看这些能力在 **指令模型** 中是如何延续与发挥的。

## [](https://huggingface.co/blog/zh/smollm3#%E5%8F%8C%E6%A8%A1%E5%BC%8F%E6%8C%87%E4%BB%A4--%E6%8E%A8%E7%90%86%E6%A8%A1%E5%9E%8B)**双模式指令 / 推理模型**

由于 SmolLM3 同时具备 **指令模式** 和 **推理模式**，我们需要在这两种模式下分别对模型进行评估，并与具备类似能力的其他模型进行对比。

### [](https://huggingface.co/blog/zh/smollm3#%E9%9D%9E%E6%8E%A8%E7%90%86%E6%A8%A1%E5%BC%8F%E8%AF%84%E4%BC%B0)**非推理模式评估**
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(31\).png)  

因此，SmolLM3 的指令模型处在**性能与计算成本的帕累托最优边界**上。现在，让我们看看在启用推理模式后模型的表现如何。

### [](https://huggingface.co/blog/zh/smollm3#%E6%8E%A8%E7%90%86%E6%A8%A1%E5%BC%8F%E8%AF%84%E4%BC%B0)**推理模式评估**
...
![](https://huggingface.co/datasets/HuggingFaceTB/images/resolve/main/smollm3/image%20\(32\).png)  

最后一个问题就是：**如何在本地使用 SmolLM3？**

# [](https://huggingface.co/blog/zh/smollm3#%E5%A6%82%E4%BD%95%E5%9C%A8%E6%9C%AC%E5%9C%B0%E8%BF%90%E8%A1%8C)如何在本地运行
...
### [](https://huggingface.co/blog/zh/smollm3#%E5%90%AF%E7%94%A8%E4%B8%8E%E5%85%B3%E9%97%AD%E6%89%A9%E5%B1%95%E6%8E%A8%E7%90%86%E6%A8%A1%E5%BC%8F)**启用与关闭扩展推理模式**
...
### [](https://huggingface.co/blog/zh/smollm3#%E4%BB%A3%E7%90%86%E5%BC%8F%E4%BD%BF%E7%94%A8%EF%BC%88agentic-usage%EF%BC%89)**代理式使用（Agentic Usage）**
...
# [](https://huggingface.co/blog/zh/smollm3#%E6%80%BB%E7%BB%93)总结
...
# [](https://huggingface.co/blog/zh/smollm3#%E8%B5%84%E6%BA%90%E9%93%BE%E6%8E%A5)资源链接
